    ...
    public void getPlayerImgage() {
        try {
            if(hero.equals("RED")) {
                ...
                rights = ImageIO.read(new FileInputStream("src/images/red/sright.png"));
...
//                fightleft = ImageIO.read(new FileInputStream("src/images/red/fightleft.png"));
            ...
            if(hero.equals("BLUE")) {
                ...
                rights = ImageIO.read(new FileInputStream("src/images/blue/sright.png"));
...
//                fightleft = ImageIO.read(new FileInputStream("src/images/purple/fightleft.png"));
            ...
            if(hero.equals("RAT")) {
                ...
                leftm = ImageIO.read(new FileInputStream("src/images/rat/movleft.png"));
...
//                fightleft = ImageIO.read(new FileInputStream("src/images/rat/fightleft.png"));
            ...
            if(hero.equals("SHREDDER")) {
                forward = ImageIO.read(new FileInputStream("src/images/shredder/forward.png"));
                backward = ImageIO.read(new FileInputStream("src/images/shredder/back.png"));

                lefts = ImageIO.read(new FileInputStream("src/images/shredder/sleft.png"));

                leftm = ImageIO.read(new FileInputStream("src/images/shredder/movleft.png"));
                rights = ImageIO.read(new FileInputStream("src/images/shredder/sright.png"));
                rightm = ImageIO.read(new FileInputStream("src/images/shredder/movright.png"));
//                fightrigt = ImageIO.read(new FileInputStream("src/images/rat/fightright.png"));
//                fightleft = ImageIO.read(new FileInputStream("src/images/rat/fightleft.png"));
            }
